...
public class TrainingDemoController {
    ...
    @RequestMapping({"/to_training_demo_2/{a}/{t}"})
    public String indexToDemo2(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime) {
        session.setAttribute("trainingdemo_answer_1_3", answer);
        session.setAttribute("trainingdemo_reaction_1_3", reactionTime);
        return "redirect:/training_demo_2";
    }

    @RequestMapping({"/to_training_demo_3/{a}/{t}"})
    public String indexToDemo3(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime) {
        session.setAttribute("trainingdemo_answer_2_3", answer);
        session.setAttribute("trainingdemo_reaction_2_3", reactionTime);
        return "redirect:/training_demo_3";
    }

    @RequestMapping({"/to_training_demo_4/{a}/{t}"})
    public String indexToDemo4(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime) {
        session.setAttribute("trainingdemo_answer_3_3", answer);
        session.setAttribute("trainingdemo_reaction_3_3", reactionTime);
        return "redirect:/training_demo_4";
    }

    @RequestMapping({"/to_training_demo_5/{a}/{t}"})
    public String indexToDemo5(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime) {
        session.setAttribute("trainingdemo_answer_4_3", answer);
        session.setAttribute("trainingdemo_reaction_4_3", reactionTime);
        return "redirect:/training_demo_5";
    }
