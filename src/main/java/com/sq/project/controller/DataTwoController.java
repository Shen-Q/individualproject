...
public class DataTwoController {
    ...
    @RequestMapping("/to_data2_demo_1")
    public String indexToData2Demo1(){
        return "data2_demo_1";
    }

    @RequestMapping("/to_data2_demo_2")
    public String indexToData2Demo2(){
        return "data2_demo_2";
    }

    @RequestMapping("/to_data2_demo_3")
    public String indexToData2Demo3(){
        return "data2_demo_3";
    }

    @RequestMapping("/to_data2_demo_4")
    public String indexToData2Demo4(){
        return "data2_demo_4";
    }

    @RequestMapping("/to_data2_demo_5")
    public String indexToData2Demo5(){
        return "data2_demo_5";
    }
    ...
    public String indexToData2Introduction_1(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime){
        ...
        int reaction_1_1 = (int)session.getAttribute("dataset1_reaction_1_1");
        ...
        int reaction_1_2 = (int)session.getAttribute("dataset1_reaction_1_2");
        ...
        int reaction_1_3 = (int)session.getAttribute("dataset1_reaction_1_3");
        ...
        int reaction_2_1 = (int)session.getAttribute("dataset1_reaction_2_1");
        ...
        int reaction_2_2 = (int)session.getAttribute("dataset1_reaction_2_2");
        ...
        int reaction_2_3 = (int)session.getAttribute("dataset1_reaction_2_3");
        ...
        int reaction_3_1 = (int)session.getAttribute("dataset1_reaction_3_1");
        ...
        int reaction_3_2 = (int)session.getAttribute("dataset1_reaction_3_2");
        ...
        int reaction_3_3 = (int)session.getAttribute("dataset1_reaction_3_3");
        ...
        int reaction_4_1 = (int)session.getAttribute("dataset1_reaction_4_1");
        ...
        int reaction_4_2 = (int)session.getAttribute("dataset1_reaction_4_2");
        ...
        int reaction_4_3 = (int)session.getAttribute("dataset1_reaction_4_3");
        ...
        trainingService.saveDataset1Result(result);
