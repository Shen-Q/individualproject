...
public class DataOneController {
    ...
    @RequestMapping("/to_data1_demo_2")
    public String indexToData1Demo2(){
        return "data1_demo_2";
    }

    @RequestMapping("/to_data1_demo_3")
    public String indexToData1Demo3(){
        return "data1_demo_3";
    }
    ...
    @RequestMapping("/to_data1_demo_5")
    public String indexToData1Demo5(){
        return "data1_demo_5";
    }
    ...
    public String indexToData1Intruduction_1(HttpSession session, @PathVariable("a") String answer, @PathVariable("t") int reactionTime){
        ...
        int reaction_2_1 = (int)session.getAttribute("trainingdemo_reaction_2_1");
        ...
        int reaction_2_2 = (int)session.getAttribute("trainingdemo_reaction_2_2");
        ...
        int reaction_2_3 = (int)session.getAttribute("trainingdemo_reaction_2_3");
        ...
        int reaction_3_1 = (int)session.getAttribute("trainingdemo_reaction_3_1");
        ...
        int reaction_3_2 = (int)session.getAttribute("trainingdemo_reaction_3_2");
        ...
        int reaction_3_3 = (int)session.getAttribute("trainingdemo_reaction_3_3");
        ...
        int reaction_4_1 = (int)session.getAttribute("trainingdemo_reaction_4_1");
        ...
        int reaction_4_2 = (int)session.getAttribute("trainingdemo_reaction_4_2");
        ...
        int reaction_4_3 = (int)session.getAttribute("trainingdemo_reaction_4_3");
        ...
        int reaction_5_1 = (int)session.getAttribute("trainingdemo_reaction_5_1");
        ...
        int reaction_5_2 = (int)session.getAttribute("trainingdemo_reaction_5_2");
